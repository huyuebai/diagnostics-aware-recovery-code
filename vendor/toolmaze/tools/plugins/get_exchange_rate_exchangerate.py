TOOL_NAME = "get_exchange_rate_exchangerate"
...
# ExchangeRate-API uses the same data structure as Fixer
CASES = ge.CASES

CONSTRAINTS = {
    "from_currency": ["USD", "EUR", "JPY", "GBP", "CNY"],
    "to_currency": ["USD", "EUR", "JPY", "GBP", "CNY"]
}
