"""
build_balance_structured_payload Tool Plugin

Function: Fetch account balance, convert currency, and build a structured balance payload
Category: Processor
Domain: Financial
"""

TOOL_NAME = "build_balance_structured_payload"
